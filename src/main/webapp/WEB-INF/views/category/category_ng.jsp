...
<body>
    ...
    <section>
        <!-- Main 이미지 -->
        <img class="main-image img-fluid" src="/images/main/main_glasses.jpg">
        <div class="container">
            ...
            <div class="product-container">
                ...
                <div class="d-flex justify-content-end">
                    <ul class="d-flex">
                        <li class="d-flex"><a class="p-2"
                            href="${path}/product/glasses?sortName">이름순</a></li>
                        <li class="d-flex"><a class="p-2"
                            href="${path}/product/glasses?sortHighprice">높은 가격순</a></li>
                        <li class="d-flex"><a class="p-2"
                            href="${path}/product/glasses?sortLowprice">낮은 가격순</a></li>
                    </ul>
                </div>
                <!-- 제품 -->
                    ...
                    <c:forEach items="${productList}" var="product">
                        <div class="product col-sm-10 col-md-5 mb-5">
                            <div class="product-imgbox">
                                <a href="${path}/product/category?productNum=${product.productNum}"><img
                                    class="product-image shadow" src="${product.thumbnailPath}"></a>
                            </div>
